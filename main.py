...
from vcd.analyzer.score.regression_model import convert_scores, RandomForestScoreAnalyzer, load_model
...
if __name__ == '__main__':
    ...
    if algorithm_type is "SIFT":
        ...
        analyzer = RandomForestScoreAnalyzer(scores, load_model(model_path))
